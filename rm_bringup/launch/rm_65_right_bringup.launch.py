...
def generate_launch_description():
    ...
    rm_65_driver = IncludeLaunchDescription(
            PythonLaunchDescriptionSource(os.path.join(get_package_share_directory(('rm_driver')),'launch', 'rm_65_right_driver.launch.py'))
    )
    ...
    rm_65_moveit_config = IncludeLaunchDescription(
            PythonLaunchDescriptionSource(os.path.join(get_package_share_directory(('rm_65_right_config')),'launch', 'real_moveit_demo.launch.py'))
    )
